...
theme.build.header = function() {
          $(`.carrinho > a > i`).remove()
          $(`.carrinho > a`).prepend(`<img class=ico src="${theme.assetsPath}/shoppingcart.svg" alt="Carrinho de Compras">`)
          $(`<button type="button" class="icon-search" id="c-search"></button>`).insertBefore(`.carrinho`);
          $(`<a href="/conta/index" id="c-account"><img class=ico src="${theme.assetsPath}/person2.svg" alt="Minha Conta"></a>`).insertBefore(`.carrinho`);
